...
function slugify(s: string) {
  return s.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '') || 'your-org';
}
      ...
      <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 13, color: T.mute, margin: '0 0 28px', lineHeight: 1.5, fontFamily: T.sans }}>
            ...
            <div style={{ display: 'grid', gap: 18 }}>
              ...
              <div>
                <div style={{
                  fontSize: 11.5, fontWeight: 500, color: T.ink2, marginBottom: 8,
                  fontFamily: T.mono, letterSpacing: 0.2, textTransform: 'uppercase',
                }}>
                  Team size
                </div>
                  ...
                  {SIZES.map((s, i) => (
                    <button
                      ...
                      style={{
                        ...
                        fontSize: 12.5, fontWeight: 500, fontFamily: T.mono,
                        cursor: 'pointer',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  {ROLES.map((r, i) => {
                    ...
                    return (
                      ...
                      >
                        <span style={{
                          width: 14, height: 14, borderRadius: 14, marginTop: 2, flexShrink: 0,
                          border: `1.5px solid ${sel ? T.navy : T.line}`,
                          background: '#fff',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                        }}>
                          {sel && <span style={{ width: 6, height: 6, borderRadius: 6, background: T.navy, display: 'block' }} />}
                        </span>
                        <div>
              ...
              {/* Region dropdown — click-outside handled via ref */}
              <div style={{ position: 'relative' }} ref={dropdownRef}>
                ...
                <div
                  ...
                  style={{
                    ...
                    justifyContent: 'space-between', fontFamily: T.mono,
                ...
                {regionOpen && (
                  <div style={{
                    ...
                    background: '#fff', border: `1px solid ${T.navy}`,
                    borderRadius: 6, zIndex: 20,
                    boxShadow: '0 4px 16px rgba(10,20,50,0.12)',
                    ...
                    {REGIONS.map((r) => (
                      <div
                        ...
                        style={{
                          padding: '10px 12px', fontSize: 13, fontFamily: T.mono,
